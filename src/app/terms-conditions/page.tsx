...
export default function TermsConditionsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-neutral-300 font-sans antialiased selection:bg-[#C8EB5F] selection:text-black overflow-x-hidden relative">
      ...
      {/* Navigation Header - Matches other pages, hides terms link to prevent header overcrowding */}
      ...
      <section className="relative pt-36 pb-16 px-6 sm:px-12 max-w-7xl mx-auto z-10 text-center">
        <div className="space-y-6 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[8px] sm:text-[9px] uppercase tracking-[0.25em] text-[#C8EB5F] font-mono select-none">
            <Scale size={11} className="text-[#C8EB5F]" />
          ...
          <p className="text-xs sm:text-sm text-neutral-400 font-light max-w-xl mx-auto leading-relaxed pt-2 font-sans">
            Please parse the following parameters governing class leaves, make-up scheduling rules, and cancellation fee retainers prior to plan subscription.
          </p>
        </div>
      </section>

      {/* Structured Content - Well SEO written (> 500 characters) containing low-competition semantic keywords */}
        ...
        <div className="p-8 sm:p-12 rounded-[36px] bg-zinc-950 border border-white/10 space-y-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <BookOpen className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">1. One-on-One Class Attendance</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Every registered path is allocated dedicated dynamic slots with a assigned scholar tutor. In implementing <strong>"online Quran academy registration rules"</strong>, we require prompt virtual classroom attendance. If a student is unable to attend, notice must be shared with helpdesk coordinates at least 6 hours in advance. This avoids duplicate scheduling blocks and maintains absolute structural efficacy.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">2. Make-Up Classes & Leaves</h2>
            </div>
            <p className="text-xs sm:text-sm text-[#999] font-light font-sans leading-relaxed">
              Any class missed due to tutor absence is automatically re-scheduled at zero additional expense. For student-related absent days notified 6 hours prior, a maximum of two makeup classes can be claimed within a single monthly cycle. Unnotified continuous absences (No-Shows) carry zero make-up options, ensuring we respect classical teacher time allocations.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <DollarSign className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">3. Tuition Fees & Cancellations</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Subscriptions are billed monthly at the start of your scheduling term. While we protect complete consumer freedom, a <strong>40% tuition retention policy applies to late cancellations</strong> processed inside the active billing cycle. This security parameter keeps our native scholar compensation packages secure and stable.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">4. Ethical Conduct Rules</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Both scholars and students are expected to maintain absolute ethical standards and digital manners during lessons. Direct personal contact exchanges or private business requests outside Tajweedpage agency coordinates are strictly prohibited, ensuring maximum privacy standards for both instructors and families.
            </p>
          </div>
      ...
      {/* Footer Block - Matches standard footer with new Privacy & Terms hyperlinks */}
