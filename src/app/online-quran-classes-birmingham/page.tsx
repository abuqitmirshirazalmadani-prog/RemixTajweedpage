    ...
    return (
      ...
      >
            ...
            <div className="my-auto space-y-8">
                ...
                <motion.main variants={containerVariants} className="space-y-6">
                    ...
                    <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-4" variants={itemVariants}>
                      {[
                        "West Midlands Personal Class Timings",
                        "Dedicated Female Scholars Group",
                        "Verifiably Sound Tajweed Phonics",
                        "Flexible Makeup Lesson Tokens",
                        "Complimentary Trial Class Included"
                      ].map((item, i) => (
        ...
        <div className="relative w-full md:w-1/2 lg:w-2/5 min-h-[350px] md:min-h-auto">
            <Image 
                src={backgroundImage} 
                alt="Tajweed Online Quran Tutors Birmingham" 
                fill 
...
export default function BirminghamQuranClasses() {
  ...
  const faqData: FAQItem[] = [
    {
      question: "Are these classes available for students in Solihull and Sutton Coldfield?",
      answer: "Yes. Our Birmingham educational registry serves the entire West Midlands area, including Solihull, Sutton Coldfield, Coventry, Dudley, and Wolverhampton. Tutors customize the lessons precisely according to local pace and focus."
    },
    {
      question: "Do you have female scholars specializing in teaching young children?",
      answer: "Absolutely. We provide handpicked, highly certified female teachers who specialize in pediatric Quran transmission. They are expert at making classes engaging, using interactive tools that help children learn with comfort."
    },
    {
      question: "Can I choose my own hours for the Tajweed syllabus?",
      answer: "Our classes run under completely flexible, customizable timing patterns. You can choose early morning or late night Zoom slots, allowing you to learn beautifully without disrupting your family&apos;s daily West Midlands routines."
    }
  ];
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                  ...
                  <div className="h-px bg-white/5 my-1" />
                  <Link href="/courses/online-hifz-classes" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-405 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                    Online Hifz Classes
                  </Link>
                  <div className="h-px bg-white/5 my-1" />
                  <Link href="/courses/quran-reading-classes-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-405 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
                  ...
                  {ukSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      ...
                      <Link href="/online-quran-classes-birmingham" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-[#C8EB5F] hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">
                        • Birmingham ✦
                      </Link>
                    </div>
                  )}
              ...
              <div className="flex flex-col items-center gap-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="p-1 hover:text-[#C8EB5F] text-neutral-455 focus:outline-none"
                  >
              ...
              <div className="flex flex-col items-center gap-1.5">
                ...
                {ukSubpagesOpen && (
                  <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1 animate-fadeIn">
                    ...
                    <Link href="/online-quran-classes-birmingham" className="text-xs uppercase tracking-wider text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Birmingham ✦</Link>
                  </div>
                )}
              </div>

              <Link href="/free-trial" className="text-lg tracking-widest uppercase text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>Book Free Trial</Link>
            </div>
      ...
      <HeroSection 
        logo={{
          ...
          alt: "TajweedPage Verified Education logo in Birmingham",
          text: "TajweedPage"
        }}
        slogan="WEST MIDLANDS PREHEMINENCE"
        title={
          <span>
            Elite Quran Coaching <br/>
            <span className="text-[#C8EB5F] font-serif italic">In Birmingham & West Midlands</span>
          </span>
        }
        subtitle="Step into high-performance 1-on-1 virtual Quran coaching portals constructed specifically for children and female adults in Birmingham. Learn correct articulation and authentic transmission (Tajweed) directly with native Azhari scholars."
        backgroundImage="https://i.postimg.cc/L5SCS1dY/pexels-seyhmuskino-34355095.jpg"
        callToAction={{
      ...
      <div className="bg-black py-20 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center mb-16">
          <span className="text-[10px] font-mono tracking-[0.3em] text-[#C8EB5F] uppercase">WEST MIDLANDS DISCIPLINE</span>
          <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white mt-3">Why Birmingham Families Rank Us First</h2>
          <p className="text-sm text-neutral-400 font-light max-w-2xl mx-auto mt-4 font-sans leading-relaxed">
            In Birmingham, our interactive system delivers customized, individual lesson slates designed to fit West Midlands routines with maximum comfort.
          </p>
        </div>

        <TextParallaxContent 
          imgUrl="https://i.postimg.cc/pTfCsL9t/pexels-seymasungr-1499342462-31544498.jpg"
          subheading="Azhari Scholars"
          heading="Expert Azhari Tutors in Birmingham"
        >
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-12 text-white">
            <h3 className="col-span-1 text-2xl font-serif font-light uppercase tracking-wide text-[#C8EB5F] md:col-span-4 leading-snug">
              Unrivaled 1-on-1 Vocal Correction Portals
            </h3>
            <div className="col-span-1 md:col-span-8 space-y-6 text-neutral-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                From central Colmore Row to suburban Solihull and Sutton Coldfield, families across Birmingham who want dedicated, verified Quran tutors choose our personal zoom portals over traditional mosque classrooms. This eliminates long travel times and busy classrooms, helping kids focus calmly on vocal feedback.
              </p>
              <p>
                Under the careful attention of our native Arabic scholars, every student masters the correct mouth shaping and tongue placement (Makharij). This structured attention helps English-speaking children recite with high fluency, building deep, quiet confidence from lesson one.
              </p>
              <div className="pt-2">
                <button 
                  onClick={() => {
        ...
        <TextParallaxContent 
          imgUrl="https://i.postimg.cc/hjBbQRCF/pexels-qaarif-16274709.jpg"
          subheading="Phonetic Foundations"
          heading="Noorani Qaida Articulation Pathways"
        >
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-12 text-white">
            <h3 className="col-span-1 text-2xl font-serif font-light uppercase tracking-wide text-[#C8EB5F] md:col-span-4 leading-snug">
              Tailored Systems For High Progress Ratios
            </h3>
            <div className="col-span-1 md:col-span-8 space-y-6 text-neutral-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                Our specialized Noorani Qaida syllabus helps children master phonetic combinations easily. Using custom digital annotations and visual whiteboards, lessons become exciting and interactive. Younger minds learn correct pronunciation rules without carrying over localized English accents.
              </p>
              <p>
                Every session is recorded in automatic record logbooks sent straight to your chat, giving West Midlands parents peace of mind while tracking their children&apos;s growth clearly.
              </p>
            </div>
          </div>
        </TextParallaxContent>
      ...
      <section className="py-24 bg-zinc-950 border-b border-white/5 relative">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            ...
            <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-none">Curated Birmingham Curriculums</h2>
            ...
            <p className="text-neutral-400 text-xs sm:text-sm font-light font-sans max-w-2xl mx-auto leading-relaxed">
              Three premium curriculums customized to match Solihull, Sutton Coldfield, and Greater Birmingham schedules seamlessly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black border border-white/5 hover:border-[#C8EB5F]/35 rounded-[32px] p-8 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group shadow-2xl">
              <div className="space-y-6">
                ...
                <p className="text-xs text-neutral-405 font-light font-sans leading-relaxed">
      ...
      <section className="py-24 bg-black border-b border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            ...
            <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-none">How Birmingham Classes Stream live</h2>
            <div className="h-px w-24 bg-[#C8EB5F] mx-auto my-4" />
          </div>
          ...
          <div className="flex flex-col md:px-0">
            ...
            >
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/Y28f0VQH/pexels-timur-weber-9127846.jpg"
                    fill
            ...
            >
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/FRpcfddn/pexels-hatice-521331727-20008289.jpg"
                    fill
            ...
            >
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/x8qkcsSf/pexels-rizkysabriansyah-36211946-(1).jpg"
                    fill
                    className="object-cover brightness-95"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-light uppercase tracking-tight text-white leading-tight">
              Azhari Tradition<br />
              <span className="text-[#C8EB5F] italic font-normal font-serif">In Your Home</span>
            </h2>
          ...
          <div className="bg-zinc-950 border border-white/5 p-8 rounded-[36px] shadow-2xl">
            <div className="mb-6 space-y-2">
              <span className="text-[9px] font-mono tracking-[0.3em] text-[#C8EB5F] uppercase font-bold block">BIRMINGHAM LOCALIZED REGISTRATION</span>
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                <span className="text-[9px] tracking-[0.3em] font-semibold text-[#C8EB5F] uppercase font-mono block">
                  {bookingType === "trial" ? "COMPLIMENTARY PASS (BIRMINGHAM)" : "DIAGNOSTIC DEMO CLASS"}
                </span>
                ...
                <p className="text-xs text-neutral-400 font-light font-sans">
                  Learn live, 1-on-1 over Zoom with highly certified Arab academic educators in Birmingham.
                </p>
              </div>
