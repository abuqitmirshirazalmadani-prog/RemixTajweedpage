    ...
    return (
      ...
      >
            ...
            <div className="my-auto space-y-8">
                ...
                <motion.main variants={containerVariants} className="space-y-6">
                    ...
                    <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-4" variants={itemVariants}>
                      {[
                        "Flexible Timelines for German Timezones",
                        "Highly Certified Al-Azhar Academics",
                        "One-on-One Customized Female Scholar Rooms",
                        "Progressive Digital Study Records",
                        "Interactive Kids Phonetic Whiteboards"
                      ].map((item, i) => (
        ...
        <div className="relative w-full md:w-1/2 lg:w-2/5 min-h-[350px] md:min-h-auto">
            <Image 
                src={backgroundImage} 
                alt="Tajweed Online Quran Tutors Germany" 
                fill 
...
export default function GermanyQuranClasses() {
  ...
  const faqData: FAQItem[] = [
    {
      question: "Are German-speaking support teams available for Quran classes in Germany?",
      answer: "Yes, our registry desk provides complete German-language coordination support to make your tracking seamless. While the main tutors recite in Arabic and explain rules in descriptive English or simple German, our communication portals help you adjust timelines easily."
    },
    {
      question: "How do you coordinate with school timetables in NRW, Bavaria, or Berlin?",
      answer: "We accommodate customized timing adjustments for German states. You are free to book late afternoon slots, evening timelines, or Saturday and Sunday morning slots that perfectly fit around school, sports clubs, or work hours."
    },
    {
      question: "Can adult sisters book handpicked Alimah scholars exclusively?",
      answer: "Absolutely. We maintain a verified network of qualified Arab scholars (with traditional Al-Azhar Ijazahs) catering exclusively to Muslim sisters in Berlin, Munich, Frankfurt, and Hamburg. This ensures an eye-to-eye private digital environment."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="font-mono text-[8px] tracking-[0.3em] text-[#C8EB5F] block uppercase font-bold">EUROPE PORTAL</span>
            </div>
          </Link>
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
            ...
            >
              ...
              <div className={cn(
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
                  ...
                  {/* Europe Dropdown - Default Open inside Germany */}
                  ...
                  {europeSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      <Link href="/online-quran-classes-germany" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-[#C8EB5F] hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">
                        • Germany ✦
                      </Link>
          ...
          >
            ...
            <div className="flex flex-col gap-6 items-center text-center my-auto py-8">
              ...
              <div className="flex flex-col items-center gap-1.5">
                ...
                {europeSubpagesOpen && (
                  <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1 animate-fadeIn">
                    <Link href="/online-quran-classes-germany" className="text-xs uppercase tracking-wider text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Germany ✦</Link>
      ...
      <HeroSection 
        logo={{
          ...
          alt: "TajweedPage Verified Education logo Germany",
          text: "TajweedPage"
        }}
        slogan="GERMAN SECTOR EXCELLENCE"
        title={
          <span>
            Premium Online Quran <br/>
            <span className="text-[#C8EB5F] font-serif italic">Classes in Germany</span>
          </span>
        }
        subtitle="Experience exclusive, high-level live 1-on-1 private virtual rooms designed precisely for children, sisters, and adults in Germany. Benefit from handpicked native Arabic scholars from Al-Azhar, interactive multi-device phonetics dashboards, and flexible scheduling optimized for CET timezones."
        backgroundImage="https://i.postimg.cc/Xv3pwN0w/pexels-gizem-gokce-1072613075-36521598.jpg"
        callToAction={{
          text: "SECURE GERMAN TRIAL",
          href: "#trial-inquiry"
        }}
        contactInfo={{
      ...
      <div className="bg-black py-20 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center mb-16">
          ...
          <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white mt-3">Why Families in Germany Excel With Us</h2>
          <p className="text-sm text-neutral-400 font-light max-w-2xl mx-auto mt-4 font-sans leading-relaxed">
            Respecting the busy timelines of students across Berlin, Munich, Hamburg, and Frankfurt, our digital framework blends classical transmission methods with modern academic tracking.
          </p>
        </div>

        <TextParallaxContent 
          imgUrl="https://i.postimg.cc/kGV4nBxq/pexels-thirdman-8489078.jpg"
          subheading="Azhari Scholars"
          heading="Top Azhari Scholars in Deutschland"
        >
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-12 text-white">
            <h3 className="col-span-1 text-2xl font-serif font-light uppercase tracking-wide text-[#C8EB5F] md:col-span-4 leading-snug">
              Authentic Recitation with Visual Feedback
            </h3>
            <div className="col-span-1 md:col-span-8 space-y-6 text-neutral-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                Germany boasts a vibrant and diverse Muslim community seeking high-caliber, classical Quranic study options. Traditional local schools or community centers are often overcrowded, running broad curricula that lack strict focus on personal development. We resolve this by providing premium 1-on-1 virtual portals with handpicked scholars.
              </p>
              <p>
                Every instructor on our panel has earned rigorous credentials (Ijazah) from elite global hubs like Al-Azhar University. This ensures correct mouth articulation (Makharij) and flawless pronounciation from your very first trial. Non-native students in Berlin and Cologne experience structured, slow, and encouraging learning atmospheres that foster deep spiritual and linguistic confidence.
              </p>
              <div className="pt-2">
                <button 
                  onClick={() => {
        ...
        <TextParallaxContent 
          imgUrl="https://i.postimg.cc/T2yg2w2Q/pexels-zeynep-sude-emek-193601188-20784497.jpg"
          subheading="Noorani Foundations"
          heading="Phonetic Foundation Systems"
        >
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-12 text-white">
            <h3 className="col-span-1 text-2xl font-serif font-light uppercase tracking-wide text-[#C8EB5F] md:col-span-4 leading-snug">
              Custom-Tailored German Timetables
            </h3>
            <div className="col-span-1 md:col-span-8 space-y-6 text-neutral-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                Proper Quranic recitation requires structured, steady feedback curves. Our Noorani Qaida framework guides younger minds and adults smoothly through simple phonetic segments, ensuring correct habits.
              </p>
              <p>
                German families appreciate our premium virtual spaces because they fit easily into strict daily routines. Our academic coordinators provide full administrative tracking, ensuring parents can monitor progress on their personal dashboard instantly.
              </p>
            </div>
          </div>
        </TextParallaxContent>
      ...
      <section className="py-24 bg-zinc-950 border-b border-white/5 relative">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            ...
            <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-none">Curated Germany Curriculums</h2>
            ...
            <p className="text-neutral-400 text-xs sm:text-sm font-light font-sans max-w-2xl mx-auto leading-relaxed">
              Three premium study circles developed by elite Islamic educators to suit student schedules across Deutschland.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black border border-white/5 hover:border-[#C8EB5F]/35 rounded-[32px] p-8 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group shadow-2xl">
              <div className="space-y-6">
                ...
                <p className="text-xs text-neutral-400 font-light font-sans leading-relaxed">
                  Tailored specifically for children ages 4-12. Focused on slowly building foundational recognition skills, correct phonics, and basic vocal rules to handle Quranic text with ease. Includes interactive digital whiteboards and play-based tools.
                </p>
              ...
              <div className="pt-8 mt-8 border-t border-white/5 flex items-center justify-between">
                <div>
                  ...
                  <span className="font-serif text-2xl text-white font-medium">€59<span className="text-xs text-neutral-405">/mo</span></span>
                </div>
                <button 
                  onClick={() => {
                    setBookingType("trial");
            ...
            <div className="bg-black border border-[#C8EB5F]/25 hover:border-[#C8EB5F] rounded-[32px] p-8 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between relative shadow-[0_0_50px_rgba(200,235,95,0.05)] group">
              ...
              <div className="pt-8 mt-8 border-t border-white/5 flex items-center justify-between">
                <div>
                  <span className="text-[9px] font-mono text-neutral-500 uppercase block tracking-wider">MEMBER INVESTMENT</span>
                  <span className="font-serif text-2xl text-white font-medium">€79<span className="text-xs text-neutral-405">/mo</span></span>
                </div>
                <button 
                  onClick={() => {
                    setBookingType("trial");
            ...
            <div className="bg-black border border-white/5 hover:border-[#C8EB5F]/35 rounded-[32px] p-8 transition-all duration-500 hover:-translate-y-2 flex flex-col justify-between group shadow-2xl">
              ...
              <div className="pt-8 mt-8 border-t border-white/5 flex items-center justify-between">
                <div>
                  <span className="text-[9px] font-mono text-neutral-500 uppercase block tracking-wider">MEMBER INVESTMENT</span>
                  <span className="font-serif text-2xl text-white font-medium">€99<span className="text-xs text-neutral-405">/mo</span></span>
                </div>
                <button 
                  onClick={() => {
                    setBookingType("trial");
      ...
      <section className="py-24 bg-black border-b border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            ...
            <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-none">How Germany Classes Stream Live</h2>
            <div className="h-px w-24 bg-[#C8EB5F] mx-auto my-4" />
          </div>
          ...
          <div className="flex flex-col md:px-0">
            ...
            >
              <motion.div style={{ y: translate1 }} className="flex-1 max-w-sm">
                ...
                >
                  Enter your details in our secure enrollment form. A senior educational register coordinator will reach you over WhatsApp or Email in under 2 hours to align customized scheduling, assign standard CET timetables, and confirm your complimentary session.
                </motion.p>
              </motion.div>
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/jShJ3nvb/pexels-mohamed-hamdi-510308652-16197216.jpg"
                    fill
                    className="object-cover brightness-95 saturate-[0.85]"
                    alt="Authentic Quran Learning Foundations Germany"
                    sizes="(max-width: 768px) 100vw, 50vw"
                    referrerPolicy="no-referrer"
                  />
            ...
            >
              <motion.div style={{ y: translate2 }} className="flex-1 max-w-sm">
                ...
                <motion.p
                  className="text-neutral-400 text-xs sm:text-sm font-light mt-6 leading-relaxed font-sans"
                >
                  Join your secure virtual portal via modern portable screens or notebooks. Your Azhari scholar works with precise phonetic highlighting, audio tracing, and custom slides, correcting vocal mistakes smoothly in a positive, friendly atmosphere.
                </motion.p>
              </motion.div>
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    ...
                    alt="Correct live articulation sessions in Germany"
                    sizes="(max-width: 768px) 100vw, 50vw"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent" />
            ...
            >
              <motion.div style={{ y: translate3 }} className="flex-1 max-w-sm">
                ...
                <h3 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-tight">Review Digital Student Logbooks</h3>
                <motion.p
                  className="text-neutral-400 text-xs sm:text-sm font-light mt-6 leading-relaxed font-sans"
                >
                  Ensure your family receives state-of-the-art feedback. Every single lesson is cataloged in our portal, tracking exactly which phonetic units were mastered and which chapters are due for revision. Get transparent weekly updates on WhatsApp.
                </motion.p>
              </motion.div>
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/FzcYyY13/pexels-abdullahoguk-32033191.jpg"
                    fill
                    className="object-cover brightness-95"
                    alt="Detailed session logbooks Germany"
                    sizes="(max-width: 768px) 100vw, 50vw"
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent" />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-light uppercase tracking-tight text-white leading-tight">
              Begin a Pristine <br />
              <span className="text-[#C8EB5F] italic font-normal font-serif">Tajweed Journey in Germany</span>
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-light leading-relaxed max-w-xl font-sans">
              Enter details securely. Our chief coordinator will contact you directly on WhatsApp or Email within 2 hours to walk through academic milestones, pair your children with a native certified Azhari scholar, and book your first free live demo class.
            </p>
          ...
          <div className="bg-zinc-950 border border-white/5 p-8 rounded-[36px] shadow-2xl">
            <div className="mb-6 space-y-2">
              <span className="text-[9px] font-mono tracking-[0.3em] text-[#C8EB5F] uppercase font-bold block">GERMANY LOCAL REGISTRATION PORTAL</span>
            ...
            {formSubmitted ? (
              <div className="bg-[#C8EB5F]/10 border border-[#C8EB5F]/20 p-8 rounded-2xl text-center space-y-4">
                ...
                <p className="text-neutral-400 text-xs font-light leading-relaxed font-sans">
                  Success! We have recorded your preferences. A coordinator will reach you over WhatsApp or Email in under 2 hours to verify scheduling.
                </p>
                <button 
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                <span className="text-[9px] tracking-[0.3em] font-semibold text-[#C8EB5F] uppercase font-mono block">
                  {bookingType === "trial" ? "COMPLIMENTARY PASS (GERMANY)" : "DIAGNOSTIC DEMO CLASS"}
                </span>
                ...
                <p className="text-xs text-neutral-400 font-light font-sans">
                  Learn live, 1-on-1 over High-Speed Zoom with highly certified Arab academic educators in Germany.
                </p>
              </div>
              ...
              {formSubmitted ? (
                <div className="bg-[#C8EB5F]/10 border border-[#C8EB5F]/30 p-6 rounded-2xl text-center space-y-4">
                  ...
                  <p className="text-neutral-400 text-xs font-light leading-relaxed font-sans">
                    Success! We will contact you over WhatsApp or Email within 2 hours to confirm your scheduled slotCET.
                  </p>
                  <button
                    onClick={() => {
                      setBookingOpen(false);
