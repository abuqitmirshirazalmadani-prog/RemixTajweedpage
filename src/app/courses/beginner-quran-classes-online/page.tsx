...
export default function BeginnerQuranClassesOnlinePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-neutral-300 font-sans antialiased selection:bg-[#C8EB5F] selection:text-black overflow-x-hidden relative">
      ...
      <section className="relative pt-36 pb-16 px-6 sm:px-12 max-w-7xl mx-auto z-10 text-center">
        <div className="space-y-6 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[8px] sm:text-[9px] uppercase tracking-[0.25em] text-[#C8EB5F] font-mono select-none">
            <Activity size={11} className="text-[#C8EB5F]" />
            STEP-BY-STEP ADULT CURRICULUM WITH EMPATHETIC IJAZAH TUTORS
          </div>
          ...
          <p className="text-xs sm:text-sm text-neutral-400 font-light max-w-xl mx-auto leading-relaxed pt-2 font-sans">
            It is never too late to begin. Start from ground zero under a slow-paced, zero-judgment curriculum designed precisely around adults and returning individuals seeking accurate sight-reading.
          </p>
      ...
      <PremiumMarquee 
        items={[
          "Beginner Quran Reading Course Online",
          "Easy Quran Lessons For Beginners",
          "Learn Quran Online Step By Step",
          "Certified Patient Native Scholar Tutors",
          "100% Live One-on-One Practical Sessions",
          "Custom Ground-Zero Pronunciation Foundations"
        ]}
        speed="80s"
        variant="brand"
      />
        ...
        <div className="p-8 sm:p-12 rounded-[36px] bg-zinc-950 border border-white/10 space-y-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">1. Simplified adult Quran curriculum</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Our structured <strong>"beginner Quran classes online"</strong> program addresses those starting entirely from scratch. Explicitly tuned with low-competition and non-cannibal search categories like **starting Quran from scratch for adults**, **simplified step-by-step adult Quran curriculum**, and **no-prior-knowledge online Quran program**, we ensure comfort and retention. Every scholar is trained to accommodate adult time structures and pacing barriers.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <HelpCircle className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">2. Slow-Paced, Empathetic Interactive Learning Environment</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-404 font-light font-sans leading-relaxed">
              For adult beginners, embarking on original Arabic phonics might feel daunting. Our classes avoid traditional fast academic pacing. Instead, certified tutors leverage dynamic feedback overlays to model sounds slowly, giving you room to test and perfect mouth shapes privately and comfortably.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">3. Individual Learning Progress Milestones</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Each student gets their private secure digital dashboard. You can track progress milestones weekly, revisit video recordings of your exact lessons, and practice correct pronunciation (Tajweed symbols) without pressure or grades. Step-by-step, start reciting lines with absolute self-reliance.
            </p>
          </div>
      ...
      <PremiumMarquee 
        items={[
          ...
          "Flexible Scheduling For Working Professionals & Busy Parents",
          "Comfortable Zero-Judgment Learning Environment"
        ]}
        speed="100s"
        variant="subtle"
      />
