...
export default function OnlineNooraniQaidaClassesPage() {
    ...
    <div className="min-h-screen bg-[#050505] text-neutral-300 font-sans antialiased selection:bg-[#C8EB5F] selection:text-black overflow-x-hidden relative">
      ...
      <section className="relative pt-36 pb-16 px-6 sm:px-12 max-w-7xl mx-auto z-10 text-center">
        <div className="space-y-6 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[8px] sm:text-[9px] uppercase tracking-[0.25em] text-[#C8EB5F] font-mono select-none">
            <Book size={11} className="text-[#C8EB5F]" />
            FOUNDATIONAL RECITATION SYLLABUS FOR BEGINNERS
          </div>
          ...
          <p className="text-xs sm:text-sm text-neutral-400 font-light max-w-xl mx-auto leading-relaxed pt-2 font-sans">
            Build perfect phonetic pronunciation from your very first letter. A structured step-by-step interactive syllabus starting from absolute basics to advanced letter connections.
          </p>
      ...
      <PremiumMarquee 
        items={[
          ...
          "Makharij & Phonics Foundations",
          "Certified Native Arab Instructors",
          "Live One-On-One Guided Alphabetic Drills",
          "Custom Progress Handouts & Guided PDF Materials",
          "Perfect For Absolute Beginners & Returning Adults"
        ]}
        speed="80s"
        variant="brand"
      />
        ...
        <div className="p-8 sm:p-12 rounded-[36px] bg-zinc-950 border border-white/10 space-y-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Volume2 className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">1. Interactive Basic Qaida Learning Strategy</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-405 font-light font-sans leading-relaxed">
              Our specialized <strong>"online Noorani Qaida classes"</strong> represent the ultimate launchpad for any child or adult embarking on digital Arabic reading. By focusing precisely on low-competition search groups such as **Noorani Qaida sounds and vowels for beginners** and **foundational Arabic phonetics for Quranic sight-reading**, our system guarantees focused progress. We prioritize individual phonics of each classic letter (Haroof) before introducing complex compound combinations.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">2. Dialect Articulation Points (Makharij)</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Noorani Qaida structure is more than standard alphabet memorization; it's the physics of sound representation. Under our certified ijazah tutors, students analyze exactly how deep throat letters, tongue taps, and nasal resonances modify individual words. This prevents early pronunciation decay, shaping flawless sight-reading mechanics.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">3. Custom Spelled Syllables (Hija rules)</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              We leverage modern interactive dashboards containing highly responsive letter boards. Students tap, hear, and repeat syllables, practicing short vowels (Fatha, Kasra, Damma), double vowels (Tanween), and silent connections (Sukun & Shaddah). This gradual climb is ideal for preschoolers and children with zero prior Arabic background.
            </p>
          </div>
      ...
      <PremiumMarquee 
        items={[
          ...
          "Flexible schedules For Diverse Lifestyles",
          "Empathetic & Slow-paced Study Formats"
        ]}
        speed="100s"
        variant="subtle"
      />
