...
export default function IslamicStudiesClassesForKidsPage() {
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                  ...
                  <div className="h-px bg-white/5 my-1" />
                  <Link href="/courses/islamic-studies-classes-for-kids" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-[#C8EB5F] hover:bg-white/5 rounded-xl transition-colors font-bold">
      ...
      <section className="relative pt-36 pb-16 px-6 sm:px-12 max-w-7xl mx-auto z-10 text-center">
        <div className="space-y-6 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[8px] sm:text-[9px] uppercase tracking-[0.25em] text-[#C8EB5F] font-mono select-none">
            <Compass size={11} className="text-[#C8EB5F]" />
            VALUES, SEERAH STORIES, & ETHICAL MUSLIM BELIEFS Curriculum
          </div>
          ...
          <p className="text-xs sm:text-sm text-neutral-400 font-light max-w-xl mx-auto leading-relaxed pt-2 font-sans">
            Nurture strong Muslim characters through engaging historical storytelling, prophetic lessons, and foundational ethical values, structured cleanly in high-end, kid-friendly classrooms.
          </p>
      ...
      <PremiumMarquee 
        items={[
          "Online Islamic Education for Kids",
          "Interactive Islamic Studies Learning",
          "Virtual Islamic Learning Classrooms",
          "Quran Classes for Kids",
          "Engaging Prophetic Seerah & Ethical Storytelling",
          "Madinah-educated Mentors & Instructors"
        ]}
        speed="80s"
        variant="brand"
      />
        ...
        <div className="p-8 sm:p-12 rounded-[36px] bg-zinc-950 border border-white/10 space-y-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)]">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Star className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">1. Interactive Islamic Manners and Akhlaq</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Our comprehensive <strong>"Islamic studies classes for kids"</strong> are designed to build a solid theological and sensory compass for Muslim children growing up in Western communities. Built entirely around low-competition search phrases like **interactive Islamic manners for children**, **fundamental Muslim beliefs classes for kids**, and **age-adapted Seerah and Hadith stories**, we ensure highly engaging delivery.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Compass className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">2. Prophetic Seerah & Hadith Visual Narratives</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              We focus on building emotional and intellectual resonance. Rather than enforcing tedious memorizing templates, our scholars guide kids through structured stories from the life of Prophet Muhammad (PBUH) and outstanding companions. Classes discuss patience, charity, honesty, and family ties directly.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Layers className="text-[#C8EB5F]" size={18} />
              <h2 className="text-lg sm:text-xl font-serif font-light tracking-wide text-white uppercase">3. Core Theological Pillar Framework</h2>
            </div>
            <p className="text-xs sm:text-sm text-neutral-400 font-light font-sans leading-relaxed">
              Our curriculum handles core Aqeedah concepts, five pillars of Islam, and authentic daily prayers (Adhkar) under clean, easy-to-follow diagrams. Each kid tracks their learning progress interactively, earning digital badges and rewards designed to drive lifelong spiritual growth.
            </p>
          </div>
      ...
      <PremiumMarquee 
        items={[
          ...
          "Structured Muslim Character Foundations",
          "Flexible After-school schedules Worldwide",
          "One-On-One Tailored Child Pace Learning",
          "Secure Virtual Study Environment"
        ]}
        speed="100s"
        variant="subtle"
      />
