            ...
            <div className="my-auto space-y-8">
                ...
                <motion.main variants={containerVariants} className="space-y-6">
                    ...
                    <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-4" variants={itemVariants}>
                      {[
                        "CST Scheduling Maps (Chicago)",
                        "Personalized Session Portals",
                        "Al-Azhar English-Speaking Female Tutors",
                        "Phonetic Shape Analysis Tracing",
                        "Free Trial Class Pass Included"
                      ].map((item, i) => (
...
const pgSections = [
  {
    id: 1,
    title: "Chicagoland Islamic Studies & Quran",
    description: "Holistic lessons combining smooth reading flow, daily prophetic du'as, and comprehensive moral character development specifically for Illinois youth.",
    imageUrl: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=600&auto=format&fit=crop",
    reverse: false
  },
  {
    id: 2,
    title: "Tajweed Fluency for Bridgeview Professionals",
    description: "Detailed live sound parsing. Master heavy articulation characteristics, correct nasal pules, and rhythmic flow safely under Al-Azhar approved scholars.",
    imageUrl: "https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?q=80&w=600&auto=format&fit=crop",
    reverse: true
  },
  {
    id: 3,
    title: "Phonetic Noorani Qaida over Zoom",
    description: "Slow-paced phonetic studies to build independent letter-combining confidence. We customize sessions around Chicago public school timetables.",
    imageUrl: "https://i.postimg.cc/fRZj2NcY/norani-qaida-english-1-page-0013-1024x1024.jpg",
    reverse: false
  }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-10 max-w-xl">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light leading-tight tracking-tight text-white uppercase">
              Start Learning Quran <br />Online in <span className="italic text-[#C8EB5F]">Chicago</span>
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-sans font-light leading-relaxed max-w-sm">
              Join personalized Quran lessons designed specifically for Muslim families and dedicated students living in Illinois and surrounding regions. Experience 1-on-1 tutoring dynamic crafted for US lifestyles.
            </p>
          ...
          {/* Right Marquee */}
          <div ref={marqueeRef} className="relative h-[550px] lg:h-[650px] flex items-center justify-center font-serif text-white uppercase font-light">
...
export default function OnlineQuranClassesChicagoPage() {
      ...
      <header className="hidden fixed top-0 left-0 w-full z-50 h-[76px] flex items-center justify-between px-6 md:px-12 bg-black/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl w-full mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-[11px] font-mono tracking-widest text-[#eeeeee]">
            ...
            >
              <button className="flex items-center gap-1 hover:text-[#C8EB5F] transition-colors duration-300 outline-none cursor-pointer font-bold">
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
            ...
            >
              <button className="flex items-center gap-1 hover:text-[#C8EB5F] transition-colors duration-300 outline-none cursor-pointer">
                <span className="text-[#C8EB5F] font-bold uppercase tracking-widest font-mono">Quran in the world</span>
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
                  ...
                  {usaSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      ...
                      <Link href="/online-quran-classes-chicago" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-[#C8EB5F] hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">
                        • Chicago ✦
                      </Link>
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              {usaSubpagesOpen && (
                <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1 animate-fadeIn">
                  ...
                  <Link href="/online-quran-classes-chicago" className="text-xs uppercase tracking-wider text-[#C8EB5F] font-bold" onClick={() => setMobileMenuOpen(false)}>• Chicago ✦</Link>
      ...
      <div className="pt-[76px] animate-none">
        <HeroSection 
          logo={{
            url: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=150&auto=format&fit=crop",
            alt: "TajweedPage.com Chicago",
            text: "TajweedPage CHI"
          }}
          slogan="ILLINOIS GREAT LAKES ACADEMICS"
          title={<>Online Quran Classes Chicago <br /><span className="text-[#C8EB5F] italic">Personalized Fluency</span> for Chicagoland</>}
          subtitle="Supportive, highly credentialed 1-on-1 online Quran & Tajweed coaching matching CST schedules for families across Chicago and Illinois."
          callToAction={{
            text: "CLAIM COMPLIMENTARY TRIAL PASS",
            href: "#"
          }}
      ...
      <section className="py-24 relative overflow-hidden bg-zinc-950 border-y border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-[10px] uppercase tracking-[0.35em] text-[#C8EB5F] font-bold">
            ...
            CHICAGOLAND TAJWEED COGNIZANCE
          </div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light font-serif tracking-tight text-white uppercase leading-tight max-w-2xl mx-auto">
            Dynamic Voice Analysis For Chicagoland Districts
          </h2>

          <p className="text-base sm:text-lg text-neutral-300 font-serif font-light leading-relaxed max-w-3xl mx-auto italic">
            At TajweedPage.com, we provide authoritative, one-on-one **online quran classes in chicago illinois** designed elegantly across Central Standard Time (CST) offsets for perfect domestic harmony.
          </p>

          <p className="text-xs sm:text-sm text-neutral-400 font-sans font-light leading-relaxed max-w-2xl mx-auto animate-none">
            Our curated sessions concentrate on local high-value queries like *chicago islamic academy quran lessons*, *best online reciters chicagoland*, and *learn quran over zoom chicago* to establish a distinct SEO footprint without cannibalizing other regional directories. We empower local students to cultivate beautiful, confident recitation under native, certified master tutors.
          </p>
      ...
      <div className="bg-black pt-32 pb-16 text-center px-4">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light text-white tracking-tight uppercase leading-none max-w-5xl mx-auto">
          Why Students in <span className="italic text-[#C8EB5F]">Chicago</span> Choose Us
        </h2>
        <div className="h-px w-24 bg-[#C8EB5F]/40 mx-auto mt-8" />
      </div>
      ...
      <div className="bg-black">
        <TextParallaxContent
          ...
          heading="CST Compatible Planners"
        >
          <ExampleContent 
            title="Schedules Crafted For Chicagoland Timings"
            desc="Easily schedule classes during cold winter days or school semesters. Our tutors operate across CST zones to accommodate late afternoon or specialized homeschooling schedules."
            ctaText="Request Custom CST Slots"
            ctaHref="#"
        ...
        <TextParallaxContent
          ...
          subheading="02 / TUTORING"
          heading="Certified Native Scholars"
        >
          <ExampleContent 
            title="Experienced Scholars with Licensed Mastery"
            desc="Our instructors hold certifications from institutions like Al-Azhar, teaching students correct makharij origins and tajweed nuances with perfect English fluency."
            ctaText="Connect with Certified Scholars"
            ctaHref="#"
            onCtaClick={() => setBookingOpen(true)}
          />
        </TextParallaxContent>
      ...
      <div className="bg-black pt-32 pb-8 text-center px-4 border-t border-white/5">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light text-white tracking-tight uppercase leading-none max-w-5xl mx-auto">
          Programs Available for <span className="italic text-[#C8EB5F]">Chicagoland</span> Families
        </h2>
      ...
      <CategoryList
        ...
        subtitle="Chicagoland Specific Policies"
        headerIcon={<HelpCircle className="h-8 w-8 text-[#C8EB5F]" />}
        categories={[
          {
            id: "ch-1",
            title: "Is there a diagnostic audio preview for beginners?",
            subtitle: "Yes, our native teachers conduct a 15-minute diagnostic recitation mapping during the complimentary demo lesson.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          },
          {
            id: "ch-2",
            title: "Do you offer Islamic studies classes alongside Quran reading?",
            subtitle: "Yes, our Islamic studies include daily manners, supplications, standard salah postures, and historical stories.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          },
          {
            id: "ch-3",
            title: "Can I choose my ideal days of the week?",
            subtitle: "Absolutely. You can choose any days from Mon-Sun, adjusting timings as needed.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          }
        ]}
      />
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <h3 className="font-serif text-2xl uppercase text-white leading-none font-light animate-none">
                ...
                <p className="text-xs text-neutral-400 font-light font-sans">
                  Learn live, one-on-one over Zoom with an elite certified Chicago tutor.
                </p>
              </div>
