            ...
            <div className="my-auto space-y-8">
                ...
                <motion.main variants={containerVariants} className="space-y-6">
                    ...
                    <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-4" variants={itemVariants}>
                      {[
                        "EST Slot Coordinates (NYC Perfect)",
                        "One-on-One Custom Logbooks",
                        "Al-Azhar Certified Female Tutors",
                        "Phonetic Mouth Shape Analysis",
...
const pgSections = [
  {
    id: 1,
    title: "Arabic Letter Phonics for NY Beginners",
    description: "Begin with our tailored Noorani Qaida lessons. For new learners starting entirely from scratch, we emphasize precise acoustic modeling to distinguish subtle Arabic letter shapes, tongue placements, and vowel notations clearly.",
    imageUrl: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=600&auto=format&fit=crop",
    reverse: false
  },
  {
    id: 2,
    title: "Tajweed Mastery for NYC Professionals",
    description: "Understand the intricate patterns of classical rules. Dive deep into articulation points (Makharij), vocal patterns, nasal controls, and proper breathing structure under Al-Azhar certified mentors.",
    imageUrl: "https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?q=80&w=600&auto=format&fit=crop",
    reverse: true
  },
  {
    id: 3,
    title: "Engaging Quran Reading for Kids in NY",
    description: "Keep young minds completely inspired and highly motivated. Our children's course provides slow-paced, interactive feedback logs, digital rewards, and supportive guides to teach kids independent reading skills easily.",
    imageUrl: "https://i.postimg.cc/Fz8CdnwQ/pexels-greg-martinez-2885370-12753175.jpg",
    reverse: false
  }
];
    ...
    >
      <motion.div style={{ y: translateContent1 }} className="flex-1 max-w-sm z-10">
        ...
        <motion.p 
          ...
          className="text-neutral-400 font-sans font-light text-xs sm:text-sm mt-8 leading-relaxed animate-none"
        >
          {section.description}
        </motion.p>
        <div className="mt-8">
      ...
      <div className="flex-1 flex justify-center items-center z-10 w-full animate-none">
        <motion.div 
          style={{ 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-10 max-w-xl">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light leading-tight tracking-tight text-white uppercase">
              Start Learning Quran <br />Online in <span className="italic text-[#C8EB5F]">New York</span>
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-sans font-light leading-relaxed max-w-sm">
              Join personalized Quran lessons designed specifically for Muslim families and dedicated students living in New York and surrounding regions. Experience a luxury 1-on-1 tutoring dynamic crafted for US lifestyles.
            </p>
...
export default function OnlineQuranClassesNewYorkPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white font-sans selection:bg-[#C8EB5F] selection:text-black">
      ...
      {/* Trigger that can be selected programmatically */}
      <button 
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
                  ...
                  {usaSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      ...
                      <Link href="/online-quran-classes-new-york" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-[#C8EB5F] hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">
                        • New York ✦
                      </Link>
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              {usaSubpagesOpen && (
                <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1 animate-fadeIn">
                  ...
                  <Link href="/online-quran-classes-new-york" className="text-xs uppercase tracking-wider text-[#C8EB5F] font-bold" onClick={() => setMobileMenuOpen(false)}>• New York ✦</Link>
      ...
      {/* Hero section with exact requested properties */}
      <div className="pt-[76px]">
        <HeroSection 
          logo={{
            url: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=150&auto=format&fit=crop",
            alt: "TajweedPage.com New York",
            text: "TajweedPage NYC"
          }}
          slogan="NEW YORK METROPOLITAN ACADEMICS"
          title={<>Online Quran Classes New York <br /><span className="text-[#C8EB5F] italic">Perfect Phonics & Tajweed</span> for NYC Families</>}
          subtitle="Empathetic, structured online Quran study programs suited for busy families and professionals in Manhattan, Brooklyn, Queens, Long Island, and Upstate New York."
          callToAction={{
            text: "BOOK FREE NYC SLOT",
            href: "#"
          }}
      ...
      {/* High-impact Dedicated Copy Block - Over 500 characters SEO Written */}
      <section className="py-24 relative overflow-hidden bg-zinc-950 border-y border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-10">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light font-serif tracking-tight text-white uppercase leading-tight max-w-2xl mx-auto">
            Comprehensive Phonics for NYC Municipalities
          </h2>

          <p className="text-base sm:text-lg text-neutral-300 font-serif font-light leading-relaxed max-w-3xl mx-auto italic">
            At TajweedPage.com, we provide premium, one-on-one **online quran classes in new york** tailored strategically around the EST timezone adjustments to prevent scheduling conflicts with school semesters or evening commutes.
          </p>

          <p className="text-xs sm:text-sm text-neutral-400 font-sans font-light leading-relaxed max-w-2xl mx-auto">
            Our specialized syllabus focuses on high-relevance terms like *online quran classes in new york for kids*, *tajweed teacher near me nyc*, and *learn quran live in new york* without overlapping or competing with our USA parent pages. We ensure NYC families connect with native, English-fluent scholars to master articulation points in a safe, elite, distraction-free environment.
          </p>
      ...
      <div className="bg-black pt-32 pb-16 text-center px-4">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light text-white tracking-tight uppercase leading-none max-w-5xl mx-auto">
          Why Students in <span className="italic text-[#C8EB5F]">New York</span> Choose Us
        </h2>
        <div className="h-px w-24 bg-[#C8EB5F]/40 mx-auto mt-8" />
      </div>
      ...
      <div className="bg-black">
        <TextParallaxContent
          ...
          subheading="01 / CONVENIENCE"
          heading="EST Compatible Time Slots"
          // We provide customized button trigger functions
        >
          <ExampleContent 
            title="Schedules Suited Around NYC Commuters"
            desc="No more rushing home through interstate traffic. We synchronize our premium lessons with NYC public school schedules so your child studies relaxed in their favorite spot right at home."
            ctaText="Request EST Slot Coordinates"
            ctaHref="#"
        ...
        <TextParallaxContent
          ...
          subheading="02 / TUTORS"
          heading="Handpicked Native Scholars"
          // We provide customized button trigger functions
        >
          <ExampleContent 
            title="Elite Certified Scholars with Perfect Accents"
            desc="Every single teacher has graduated from prestigious institutions like Al-Azhar or Umm Al-Qura with formal licenses (Ijazah) in Tajweed. Your kids learn standard phonetic articulation from certified professionals."
            ctaText="Meet Tutors Virtually"
            ctaHref="#"
            onCtaClick={() => setBookingOpen(true)}
          />
        </TextParallaxContent>
      ...
      <div className="bg-black pt-32 pb-8 text-center px-4 border-t border-white/5">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light text-white tracking-tight uppercase leading-none max-w-5xl mx-auto">
          Programs Available for <span className="italic text-[#C8EB5F]">New York</span> Families
        </h2>
      ...
      <CategoryList
        ...
        subtitle="NYC Specific Policies & Queries"
        headerIcon={<HelpCircle className="h-8 w-8 text-[#C8EB5F]" />}
        categories={[
          {
            id: "ny-1",
            title: "Are lessons scheduled around NYC school semesters?",
            subtitle: "Yes, our programs align perfectly. You can request changes during breaks or summer vacations dynamically.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          },
          {
            id: "ny-2",
            title: "Do you have female instructors for children and sisters?",
            subtitle: "Absolutely. We have a dedicated pool of English-fluent female Quran scholars for custom 1-on-1 female-led classes.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          },
          {
            id: "ny-3",
            title: "Can I cancel or reschedule classes dynamically?",
            subtitle: "Yes, with a brief 6-hour note to your dedicated coordinator via WhatsApp, we reschedule without any fee.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          }
        ]}
      />
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <p className="text-xs text-neutral-400 font-light font-sans">
                  Learn live, one-on-one over Zoom with an elite certified New York tutor.
                </p>
              </div>
