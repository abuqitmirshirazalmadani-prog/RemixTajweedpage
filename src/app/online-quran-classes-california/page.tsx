            ...
            <div className="my-auto space-y-8">
                ...
                <motion.main variants={containerVariants} className="space-y-6">
                    ...
                    <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-4" variants={itemVariants}>
                      {[
                        "PST Target Timetables (California)",
                        "One-on-One Live Zoom Portals",
                        "Sanitized Recitation Audits",
                        "Adult-centric Tajweed Pathways",
                        "Free Personal Trial Class Map"
                      ].map((item, i) => (
...
const pgSections = [
  {
    id: 1,
    title: "Makharij Pronunciation for Adults",
    description: "Especially paced lessons focusing on phonetic refinement. We help California adults master precise tongue positioning, heavy and light letter traits, and proper throat coordination accurately.",
    imageUrl: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=600&auto=format&fit=crop",
    reverse: false
  },
  {
    id: 2,
    title: "Bay Area Private Tajweed",
    description: "Highly rigorous customized syllabi crafted for intellectual professionals. Analyze voice dynamics, pause notations, and phonetic breathing boundaries one-on-one.",
    imageUrl: "https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?q=80&w=600&auto=format&fit=crop",
    reverse: true
  },
  {
    id: 3,
    title: "Gentle Noorani Qaida for Kids in Los Angeles",
    description: "Playful interactive screens, bright reward trackers, and certified instructors to build independent reading speed without mental exhaustion.",
    imageUrl: "https://i.postimg.cc/y8dqMFj3/Noorani-Qaida-Page-25.jpg",
    reverse: false
  }
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-10 max-w-xl">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light leading-tight tracking-tight text-white uppercase">
              Start Learning Quran <br />Online in <span className="italic text-[#C8EB5F]">California</span>
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-sans font-light leading-relaxed max-w-sm">
              Join personalized Quran lessons designed specifically for Muslim families and dedicated students living in California and surrounding regions. Experience a luxury 1-on-1 tutoring dynamic crafted for US lifestyles.
            </p>
...
export default function OnlineQuranClassesCaliforniaPage() {
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
                  ...
                  {usaSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      <Link href="/online-quran-classes-california" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-[#C8EB5F] hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">
                        • California ✦
                      </Link>
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              {usaSubpagesOpen && (
                <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1 animate-fadeIn">
                  <Link href="/online-quran-classes-california" className="text-xs uppercase tracking-wider text-[#C8EB5F] font-bold" onClick={() => setMobileMenuOpen(false)}>• California ✦</Link>
      ...
      {/* Hero section with exact properties */}
      <div className="pt-[76px]">
        <HeroSection 
          logo={{
            url: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?q=80&w=150&auto=format&fit=crop",
            alt: "TajweedPage.com California",
            text: "TajweedPage CA"
          }}
          slogan="CALIFORNIA PACIFIC ACADEMICS"
          title={<>Online Quran Classes California <br /><span className="text-[#C8EB5F] italic">Calm, Focused Studies</span> for West Coast Families</>}
          subtitle="One-on-one live Quran lessons tailored for adults and children in Los Angeles, the San Francisco Bay Area, San Diego, Sacramento, and across California."
          callToAction={{
            text: "BOOK FREE CALI TRIAL",
            href: "#"
          }}
      ...
      <section className="py-24 relative overflow-hidden bg-zinc-950 border-y border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-10">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light font-serif tracking-tight text-white uppercase leading-tight max-w-2xl mx-auto">
            Adaptable Live Sessions For PST Lifestyles
          </h2>

          <p className="text-base sm:text-lg text-neutral-300 font-serif font-light leading-relaxed max-w-3xl mx-auto italic">
            At TajweedPage.com, we provide flexible, authoritative **online quran classes in california for adults** and kids, setting timings to correspond perfectly with the Pacific Standard Time coordinates (PST).
          </p>

          <p className="text-xs sm:text-sm text-neutral-400 font-sans font-light leading-relaxed max-w-2xl mx-auto">
            We target low-competition local keys like *los angeles quran tutors*, *bay area tajweed courses online*, and *california islamic tutors* to avoid competing with our primary folders. This structure ensures our students receive tailored reading models from certified native mentors without standard lesson overlaps.
          </p>
      ...
      <div className="bg-black pt-32 pb-16 text-center px-4">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light text-white tracking-tight uppercase leading-none max-w-5xl mx-auto">
          Why Students in <span className="italic text-[#C8EB5F]">California</span> Choose Us
        </h2>
        <div className="h-px w-24 bg-[#C8EB5F]/40 mx-auto mt-8" />
      </div>
      ...
      <div className="bg-black">
        <TextParallaxContent
          ...
          subheading="01 / SCHEDULING"
          heading="PST Tailored Slots (CA)"
        >
          <ExampleContent 
            title="Schedules Made for Silicon Valley & LA Timings"
            desc="No rush. Our expert program operates around CA school calendars so parents never have block out tight business routines. Book dynamic slots on weekends or evenings."
            ctaText="Request Custom PST Clock Coordinates"
            ctaHref="#"
        ...
        <TextParallaxContent
          ...
          heading="Qualified Native Scholars"
        >
          <ExampleContent 
            title="Ijazah-holding Female Scholars"
            desc="Every teacher undergoes detailed acoustic vetting. They translate delicate pronunciation details with absolute English clarity, creating an encouraging environment for West Coast kids."
            ctaText="Connect with Scholars Now"
            ctaHref="#"
            onCtaClick={() => setBookingOpen(true)}
          />
        </TextParallaxContent>
      ...
      <div className="bg-black pt-32 pb-8 text-center px-4 border-t border-white/5">
        ...
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-serif font-light text-white tracking-tight uppercase leading-none max-w-5xl mx-auto">
          Programs Available for <span className="italic text-[#C8EB5F]">California</span> Students
        </h2>
      ...
      <CategoryList
        ...
        subtitle="California Specific Policies"
        headerIcon={<HelpCircle className="h-8 w-8 text-[#C8EB5F]" />}
        categories={[
          {
            id: "ca-1",
            title: "Can I choose my ideal frequency of lessons per week?",
            subtitle: "Yes, you can schedule 2, 3, or daily quick sessions. Our backend matches this securely with your designated teacher.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          },
          {
            id: "ca-2",
            title: "Are there lessons explicitly for professional adults?",
            subtitle: "Yes. Our classes cater directly to working professionals needing evening tajweed drills or flexible voice coaching.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          },
          {
            id: "ca-3",
            title: "What technology is required?",
            subtitle: "Just a stable standard internet link, standard headphones, and Zoom or Google Meet on your tablet or smartphone.",
            icon: <ArrowUpRight className="h-5 w-5" />,
          }
        ]}
      />
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <p className="text-xs text-neutral-400 font-light font-sans">
                  Learn live, one-on-one over Zoom with an elite certified California tutor.
                </p>
              </div>
