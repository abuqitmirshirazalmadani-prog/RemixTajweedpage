    ...
    return (
      ...
      >
            ...
            <div className="my-auto space-y-8">
                ...
                <motion.main variants={containerVariants} className="space-y-6">
                    ...
                    <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg mb-4" variants={itemVariants}>
                      {[
                        "Custom BST / Manchester Class Slates",
                        "Focused Female Alimah Registry",
                        "Azhari Classical Accent Verification",
                        "North West Premium Standard syllabus",
        ...
        <div className="relative w-full md:w-1/2 lg:w-2/5 min-h-[350px] md:min-h-auto">
            <Image 
                src={backgroundImage} 
                alt="Tajweed Online Quran Tutors Manchester" 
                fill 
...
export default function ManchesterQuranClasses() {
  ...
  const faqData: FAQItem[] = [
    {
      question: "Which parts of Greater Manchester do your students come from?",
      answer: "We serve families and busy professionals all over Greater Manchester. Our current students reside in locations such as Trafford, Altrincham, Salford, Bury, Rochdale, Oldham, and suburban Didsbury and Chorlton-cum-Hardy."
    },
    {
      question: "Are your female Azhari teachers available for busy North West schedules?",
      answer: "Yes. Our female Alimah scholars from elite Islamic institutions provide customized schedules. Whether you need late evening sessions or weekend times, we customize class structures to fit your routine perfectly."
    },
    {
      question: "Do you offer Noorani Qaida for bilingual kids in Manchester?",
      answer: "Absolutely. We specialize in teaching English-speaking Muslim kids. Tutors utilize simple phonics-based approaches to make letter-blending intuitive, forming proper vocal patterns right from the start."
    }
  ];
...
<Link href="/courses/female-quran-teacher-online" className="block px-4 py-2.5 text-[10px] tracking-wider font-mono text-neutral-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
                  ...
                  {ukSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      ...
                      <Link href="/online-quran-classes-manchester" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-[#C8EB5F] hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">
                        • Manchester ✦
                      </Link>
              ...
              <div className="flex flex-col items-center gap-1.5">
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="p-1 hover:text-[#C8EB5F] text-neutral-455 focus:outline-none"
                  >
                    <ChevronRight size={14} className={cn("transition-transform duration-200", ukSubpagesOpen ? "rotate-90" : "")} />
                  </button>
                </div>
                {ukSubpagesOpen && (
                  <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1 animate-fadeIn">
                    ...
                    <Link href="/online-quran-classes-manchester" className="text-xs uppercase tracking-wider text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Manchester ✦</Link>
      ...
      <HeroSection 
        logo={{
          ...
          alt: "TajweedPage Verified Education logo in Manchester",
          text: "TajweedPage"
        }}
        slogan="GREATER MANCHESTER INFLUENCE"
        title={
          <span>
            Online Quran Lessons <br/>
            <span className="text-[#C8EB5F] font-serif italic">In Greater Manchester</span>
          </span>
        }
        subtitle="Claim custom-molded, highly prestigious 1-on-1 virtual Quran lesson portals in Greater Manchester, Trafford, and Salford. Learn correct articulation (Makharij) and smooth Tajweed melody with elite certified female and male scholars."
        backgroundImage="https://images.unsplash.com/photo-1530893609608-32a9af3aa95c?q=80&w=1500&auto=format&fit=crop"
        callToAction={{
      ...
      <div className="bg-black py-20 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center mb-16">
          <span className="text-[10px] font-mono tracking-[0.3em] text-[#C8EB5F] uppercase">NORTH WEST INTELLECTUAL STANDARD</span>
          <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white mt-3">Why Manchester Devotes to Our Scholars</h2>
          <p className="text-sm text-neutral-400 font-light max-w-2xl mx-auto mt-4 font-sans leading-relaxed">
            Greater Manchester relies on our high-speed, interactive study frameworks. We structure customized calendars to match the dynamic pace of northern families seamlessly.
          </p>
        </div>

        <TextParallaxContent 
          imgUrl="https://images.unsplash.com/photo-1530893609608-32a9af3aa95c?q=80&w=1500&auto=format&fit=crop"
          subheading="Azhari Scholars"
          heading="Certified Azhari Teachers in Manchester"
        >
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-12 text-white">
            <h3 className="col-span-1 text-2xl font-serif font-light uppercase tracking-wide text-[#C8EB5F] md:col-span-4 leading-snug">
              Unrivaled 1-on-1 Live Accent Perfecting
            </h3>
            <div className="col-span-1 md:col-span-8 space-y-6 text-neutral-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                From Trafford and Chorlton to Altrincham, families across Greater Manchester seeking top-character Islamic Quran tutors choose our personal video portals. Rather than forcing kids to spend weekends commuting or learning in crowded, noisy settings, we bring the finest native Arab female and male Alimah scholars directly into your living room.
              </p>
              <p>
                Every individual student benefits from dedicated visual attention. We focus deeply on correct vocalization, making sure complex sounds such as the Arabic letters Haa, Ayn, and Saad are pronounced with absolute perfection. Non-Arabic speaking kids learn to recitate fluently without carrying non-native acoustic habits.
              </p>
              <div className="pt-2">
                <button 
                  onClick={() => {
        ...
        <TextParallaxContent 
          imgUrl="https://i.postimg.cc/zvmmgBsf/pexels-serhattugg-20558200.jpg"
          subheading="Structured Methods"
          heading="Phonetic Precision"
        >
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-6 pb-24 pt-12 md:grid-cols-12 text-white">
            <h3 className="col-span-1 text-2xl font-serif font-light uppercase tracking-wide text-[#C8EB5F] md:col-span-4 leading-snug">
              Interactive Tools For Progressive Learning
            </h3>
            <div className="col-span-1 md:col-span-8 space-y-6 text-neutral-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                Our Noorani Qaida syllabus sets the baseline for deep visual learning. Younger minds understand complex classical pronunciation rules using custom gamified tools and real-time interactive whiteboards. This keeps children active, engaged, and eager to return to their personal video portal.
              </p>
              <p>
                Parents can track progress through automatic record logbooks sent straight to their chat. This ensures you always know exactly how many lines have been successfully committed to memory, making your family&apos;s educational investment highly rewarding.
              </p>
            </div>
          </div>
        </TextParallaxContent>
      ...
      <section className="py-24 bg-zinc-950 border-b border-white/5 relative">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            ...
            <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-none">Curated Manchester Curriculums</h2>
            ...
            <p className="text-neutral-400 text-xs sm:text-sm font-light font-sans max-w-2xl mx-auto leading-relaxed">
              Syllbuses customized to align perfectly with North West school schedules and Islamic high standards.
            </p>
          </div>
      ...
      <section className="py-24 bg-black border-b border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
            ...
            <h2 className="text-4xl font-serif font-light uppercase tracking-tight text-white leading-none">How Manchester Classes Stream live</h2>
            <div className="h-px w-24 bg-[#C8EB5F] mx-auto my-4" />
          </div>
          ...
          <div className="flex flex-col md:px-0">
            ...
            >
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/DzmRpLFX/pexels-safa-6873647.jpg"
                    fill
            ...
            >
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://images.unsplash.com/photo-1530893609608-32a9af3aa95c?q=80&w=1024&auto=format&fit=crop"
                    fill
            ...
            >
              ...
              >
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-zinc-950">
                  <Image
                    src="https://i.postimg.cc/Hn1KLNM9/pexels-firman-marek-brew-2148918143-36319872-(1).jpg"
                    fill
                    className="object-cover brightness-95"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-light uppercase tracking-tight text-white leading-tight">
              ...
              <span className="text-[#C8EB5F] italic font-normal font-serif">Azhari Excellence</span>
            </h2>
          ...
          <div className="bg-zinc-950 border border-white/5 p-8 rounded-[36px] shadow-2xl">
            <div className="mb-6 space-y-2">
              <span className="text-[9px] font-mono tracking-[0.3em] text-[#C8EB5F] uppercase font-bold block">MANCHESTER LOCALIZED REGISTRATION</span>
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                <span className="text-[9px] tracking-[0.3em] font-semibold text-[#C8EB5F] uppercase font-mono block">
                  {bookingType === "trial" ? "COMPLIMENTARY PASS (MANCHESTER)" : "DIAGNOSTIC DEMO CLASS"}
                </span>
                ...
                <p className="text-xs text-neutral-400 font-light font-sans">
                  Learn live, 1-on-1 over Zoom with highly certified Arab academic educators in Manchester.
                </p>
              </div>
