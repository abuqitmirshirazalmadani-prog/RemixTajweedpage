...
export function Header({ onBookingClick, className }: HeaderProps) {
  // Dropdown states
  const [courseDropdownOpen, setCourseDropdownOpen] = useState(false);
  const [wordDropdownOpen, setWordDropdownOpen] = useState(false);
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
  
  // Mobile subpage accordions
  ...
  const handleFreeTrialClick = (e: React.MouseEvent) => {
    if (onBookingClick) {
      e.preventDefault();
      onBookingClick();
    }
  ...
  return (
    <>
      <header className={cn(
        "fixed top-0 left-0 w-full z-40 bg-black/75 backdrop-blur-md border-b border-white/5 py-4 px-6 md:px-12",
        className
      )}>
          ...
          <nav className="hidden md:flex items-center gap-8 text-[11px] font-mono tracking-widest text-[#eeeeee]">
            ...
            >
              ...
              <div className={cn(
                ...
                <div className="bg-zinc-950 border border-white/10 rounded-2xl p-2.5 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.9)] max-h-[80vh] overflow-y-auto">
                  ...
                  {usaSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      <Link href="/online-quran-classes-california" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• California</Link>
                      <Link href="/online-quran-classes-chicago" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• Chicago</Link>
                      <Link href="/online-quran-classes-new-york" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• New York</Link>
                      <Link href="/online-quran-classes-texas" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• Texas</Link>
                    </div>
                  )}
                  ...
                  {ukSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      <Link href="/online-quran-classes-london" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• London</Link>
                      <Link href="/online-quran-classes-manchester" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• Manchester</Link>
                      <Link href="/online-quran-classes-birmingham" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• Birmingham</Link>
                    </div>
                  )}
                  ...
                  {europeSubpagesOpen && (
                    <div className="pl-4 pr-1 py-1 space-y-0.5 border-l border-white/10 ml-4 mb-2">
                      <Link href="/online-quran-classes-germany" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• Germany</Link>
                      <Link href="/online-quran-classes-france" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• France</Link>
                      <Link href="/online-quran-classes-netherlands" className="block px-3 py-1.5 text-[9px] tracking-wider font-mono text-neutral-400 hover:text-[#C8EB5F] hover:bg-white/5 rounded-lg transition-colors font-semibold">• Netherlands</Link>
                    </div>
                  )}
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-0 bg-black/95 backdrop-blur-xl z-35 flex flex-col items-center justify-start gap-4 border-b border-[#C8EB5F]/20 pt-24 pb-12 overflow-y-auto px-6"
          >
            ...
            <Link 
              ...
              className="text-xs uppercase tracking-wider text-white hover:text-[#C8EB5F] transition-colors"
            ...
            <Link 
              ...
              className="text-xs uppercase tracking-wider text-[#aaaaaa] hover:text-white transition-colors"
              onClick={() => setMobileMenuOpen(false)}
            >
              Tajweed Course
            </Link>
            ...
            <div className="flex flex-col items-center gap-1.5">
              <div className="flex items-center gap-2">
                <Link 
                  ...
                  className="text-xs uppercase tracking-wider text-[#C8EB5F] hover:text-white transition-colors font-medium"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Quran Classes in USA
                </Link>
              ...
              {usaSubpagesOpen && (
                <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1">
                  <Link href="/online-quran-classes-california" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• California</Link>
                  <Link href="/online-quran-classes-chicago" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Chicago</Link>
                  <Link href="/online-quran-classes-new-york" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• New York</Link>
                  <Link href="/online-quran-classes-texas" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Texas</Link>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              {ukSubpagesOpen && (
                <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1">
                  <Link href="/online-quran-classes-london" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• London</Link>
                  <Link href="/online-quran-classes-manchester" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Manchester</Link>
                  <Link href="/online-quran-classes-birmingham" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Birmingham</Link>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col items-center gap-1.5">
              ...
              {europeSubpagesOpen && (
                <div className="flex flex-col items-center gap-1 pl-3 border-l border-white/10 my-1">
                  <Link href="/online-quran-classes-germany" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Germany</Link>
                  <Link href="/online-quran-classes-france" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• France</Link>
                  <Link href="/online-quran-classes-netherlands" className="text-[10px] uppercase tracking-wider text-neutral-400 hover:text-[#C8EB5F]" onClick={() => setMobileMenuOpen(false)}>• Netherlands</Link>
                </div>
              )}
            </div>
            ...
            {onBookingClick ? (
              <button
                ...
                className="bg-[#C8EB5F] text-black hover:bg-white text-[10px] font-mono font-bold tracking-widest px-8 py-3 rounded-full uppercase transition-all duration-300 shadow-[0_4px_15px_rgba(200,235,95,0.25)] select-none text-center cursor-pointer"
              >
                FREE TRIAL
              </button>
            ) : (
